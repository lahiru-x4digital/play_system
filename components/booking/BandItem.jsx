    ...
    return (
        <div className='flex flex-col items-center justify-center' key={barcode.id}>
            ...
            >
                ...
                <div style={{ fontSize: '8pt', wordBreak: 'break-all', textAlign: 'center' }}>{new Date(barcode?.created_date).toLocaleDateString()}</div>
                ...
                <div style={{ fontSize: '8pt', wordBreak: 'break-all', textAlign: 'center' }}>
                    {new Date(barcode?.created_date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                </div>
