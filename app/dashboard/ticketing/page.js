...
export default function page() {
 ...
 const isAdmin = useIsAdmin();
  ...
  const steps = [
    { id: "mobile", title: "Mobile Number", icon: <PhoneIcon className="h-4 w-4" /> },
    { id: "profile", title: "Customer Profile", icon: <UserIcon className="h-4 w-4" /> },
    { id: "booking", title: "Create Booking", icon: <ShoppingCartIcon className="h-4 w-4" /> },
    { id: "confirmation", title: "Confirmation", icon: <BarcodeIcon className="h-4 w-4" /> },
  ];
        ...
        />
         ...
         {activeStep === 1 && (
              <div className="space-y-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold tracking-tight">Customer Profile</h2>
          ...
          <div className='flex gap-2 justify-end'>
            {/* back btn */}
            <Button variant="outline" onClick={() => setActiveStep((prev) => (prev - 1))} className="cursor-pointer">
            Back
          </Button>
         {activeStep === 0 && <Button 
          onClick={(e) => {
